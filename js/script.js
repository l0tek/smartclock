...
var timerID = setInterval(function() {
    var owUrl = "http://api.openweathermap.org/data/2.5/weather?q=Halberstadt&units=metric&appid=1359dd1a7c1922e2aa7d486c869f3b3c";
	$.getJSON( owUrl, function(data) { 
		$("#weather_ex").html(data.main.temp + ' &deg;C' + '<br>' + '<i class="owf owf-' + data.weather[0].id + '"></i>');
